...
function listenTo(keyUp, keyDown, source) {
...
function keys(source) {
    ...
    var keyUp = compose(keycode, setState.bind(undefined, false));
    var keyDown = compose(keycode, setState.bind(undefined, true));
    ...
    _keys.up = keyUp;
    _keys.down = keyDown;
    _keys.isdown = getState;
    _keys.isup = not(getState);
